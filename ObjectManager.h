 ...
 * ObjectManager.h
 *
 * Note: This is a generic interface for an Object Manager,
 * which was provided by a third party. The implementation in
 * the ObjectManager.c file is entirely my own.
 *
